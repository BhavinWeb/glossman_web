@extends('admin.layouts.app') @section('title') {{ __('edit') }} @endsection @section('content')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="align-items-center ml-auto">
                        <a href="{{ route('module.customer.index') }}" class="btn bg-primary float-right d-flex align-items-center justify-content-center">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('module.customer.updates', $customer->id) }}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-8">
                                @method('PUT') @csrf @php $str_arr = explode (" ", $customer->name); @endphp
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <x-forms.label name="first_name" required="true" />
                                        <input value="{{ $str_arr[0]  ?? old('first_name') }}" name="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" placeholder="{{ __('first_name') }}" />
                                        @error('first_name')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ $str_arr[1] ?? old('last_name') }}" name="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" placeholder="{{ __('last_name') }}" />
                                        @error('last_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ $customer->email ?? old('email') }}" disabled name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{ __('email') }}" />
                                        @error('email')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ $customer->phone ?? old('phone') }}" disabled name="phone" type="text" class="form-control @error('phone') is-invalid @enderror" placeholder="{{ __('phone') }}" />
                                        @error('phone')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ old('password') }}" name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="{{ __('password') }}" />
                                        @error('password')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-4 col-sm-4">
                                        <button type="submit" class="btn btn-success"><i class="fas fa-sync"></i> {{ __('edit') }}</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input
                                            ...
                                            data-default-file="{{asset('uploads/user_image/'.$customer->image) }}"
