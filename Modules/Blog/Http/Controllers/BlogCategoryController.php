...
class BlogCategoryController extends Controller
{
    ...
    {
        abort_if(!userCan('postCategory.view'), 403);
    ...
    {
        abort_if(!userCan('postCategory.create'), 403);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('module.blog.category.index');
    }
    ...
    {
        abort_if(!userCan('postCategory.update'), 403);
    ...
    {
        abort_if(!userCan('postCategory.delete'), 403);
