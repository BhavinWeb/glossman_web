        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form class="form-horizontal" action="{{ route('module.blog.update', $post->id) }}" method="POST"
                        ...
                        <div class="row justify-content-center pt-3 pb-4">
                            <div class="col-md-9 px-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea rows="5" type="text" class="form-control" name="short_description" rows="3"
                                            placeholder="{{ __('short_description') }}">{{ $post->short_description }}</textarea>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{ __('description') }}<small
                                            class="text-danger">*</small></label>
                                    <div class="col-sm-10">
                                        <textarea id="editor2" type="text" class="form-control" name="description" placeholder="{{ __('description') }}">{{ $post->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger font-size-13"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10 text-center">
                                        <button type="submit" value="draft" name="status" class="btn btn-success"><i
                                                class="fas fa-sync"></i>&nbsp;{{ __('save_as_draft') }}</button>
                            ...
                            <div class="col-md-3 text-center">
                                <label class="form-label mb-5">{{ __('thumbnail') }}</label> <br>
                                <input type="file" accept="image/png, image/jpg, image/jpeg" name="image"
                                    ...
                                    data-default-file="{{ $post->image_url }}" data-max-file-size="3M"
