                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('language.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <x-forms.label name="code" required="true" labelclass="col-sm-3" />
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <x-forms.label name="direction" required="true" labelclass="col-sm-3" />
                                    <div class="col-sm-9">
                                        <select name="direction"
                                            class="form-control @error('direction') is-invalid @enderror">
                                            <option {{ old('direction') == 'ltr' ? 'selected' : '' }} value="ltr">LTR
                                            </option>
                                            <option {{ old('direction') == 'rtl' ? 'selected' : '' }} value="rtl">RTL
                                            </option>
                                        </select>
                                        @error('direction')
                                            <span class="invalid-feedback"
                                ...
                                <div class="form-group row">
                                    <x-forms.label name="flag" required="true" labelclass="col-sm-3" />
                                    <div class="col-sm-9">
