            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('service_product_list') }}</h3>
                        
                            <a href="{{ route('module.service_p.create') }}"
                                ...
                                <tr class="text-center">
                                    ...
                                    @php 
                                        function get_category($id){
                                            $db = DB::table('services')->where('id',$id)->first();
                                        ...
                                        @if (userCan('category.update') || userCan('category.delete'))
                                            <td class="text-center">
                                                @if (userCan('category.update'))
                                                    ...
                                                    <a title="{{ __('edit') }}"
                                                        href="{{ route('module.service_p.edit', $category->id) }}"
