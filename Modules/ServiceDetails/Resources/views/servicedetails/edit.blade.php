            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('edit_service_product') }}</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-10 offset-md-1">
                            <form enctype="multipart/form-data" action="{{ route('module.service_p.update',$service_p->id) }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="service_category_id"
                                                ...
                                                <option {{ $service_p->service_category_id  == $category->id ? 'selected' : '' }}
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input name="date" type="time"
                                                ...
                                                placeholder="{{ __('date') }}" value="{{$service_p->time}}">
                                            @error('date')
                                                <span class="invalid-feedback"
                                                    role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input  name="price" type="number"
                                                ...
                                                placeholder="{{ __('price') }}" value="{{$service_p->price}}">
                                            @error('price')
                                                <span class="invalid-feedback"
                                                    role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" type="text" class="form-control" name="about_service" rows="5"
                                                placeholder="{{ __('aboutservice') }}"> {{$service_p->about_service}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-5">
