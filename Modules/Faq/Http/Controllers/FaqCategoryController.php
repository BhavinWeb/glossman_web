...
class FaqCategoryController extends Controller
{
    ...
    {
        abort_if(!userCan('faqCategory.view'), 403);
    ...
    {
        abort_if(!userCan('faqCategory.create'), 403);
    ...
    {
        abort_if(!userCan('faqCategory.update'), 403);
    ...
    {
        abort_if(!userCan('faqCategory.delete'), 403);
