...
Route::prefix('admin')->middleware(['auth:admin', 'set_lang'])->group(function () {
    ...
    Route::prefix('category')->group(function () {
        ...
        Route::get('/{category:slug}/show', [CategoryController::class, 'show'])->name('module.category.show');
    ...
    Route::prefix('subcategory')->group(function () {
        ...
        Route::get('/{slug}', [SubCategoryController::class, 'index'])->name('module.subcategory.catshow');
        Route::get('/add/{parentId}', [CategoryController::class, 'create'])->name('module.subcategory.create');
        ...
        Route::get('/{subcategory:slug}/show', [SubCategoryController::class, 'show'])->name('module.subcategory.show');
