                        ...
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal"
                                ...
                                <div class="form-group row mb-15">
                                    <label class="col-sm-3 form-label">{{ __('name') }}</label>
                                    <div class="col-sm-9">
                                        <select name="parent_id"
                                            class="select2bs4 @error('parent_id') is-invalid @enderror w-100-p">
                                            @foreach ($categories as $category)
                                                <option {{ $subcategory->parent_id == $category->id ? 'selected' : '' }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="image" type="file" accept="image/png, image/jpg, image/jpeg"
                                            ...
                                            data-default-file="{{ $subcategory->image_url }}" data-max-file-size="3M"
