            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('create') }}
                        </h3>
                        ...
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('module.subcategory.store') }}" method="POST"
                                        ...
                                        <select name="parent_id"
                                            ...
                                            @foreach ($categories as $category)
                                                ...
                                                @if ($category->parent_id == null)
                                                    <option {{ old('id') == $category->id ? 'selected' : '' }}
                                                        value="{{ $category->id }}">
                                                        {{ $category->name }}
                                                    </option>
                                                @endif
                                                ...
                                                @foreach ($category->subcategories as $subcategory)
                                                    ...
                                                    @foreach ($subcategory->subcategories as $subsubcategory)
                                                        ...
                                                        @if ($subcategoryid == $subsubcategory->parent_id)
                                                            <option
                                                                {{ old('parent_id') == $subsubcategory->id ? 'selected' : '' }}
                                                        ...
                                                        @foreach ($subsubcategory->subcategories as $subsubsubcategory)
                                                            ...
                                                            @if ($subsubcategoryid == $subsubsubcategory->parent_id)
                                                                <option
                                                                    {{ old('parent_id') == $subsubsubcategory->id ? 'selected' : '' }}
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">{{ __('subcategory') }}</label>
                                    <div class="col-sm-9">
