                ...
                <div class="card">
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('module.driver.update',$data->id) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{$data->phone}}" name="phone" type="number"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{$data->password}}" name="password" type="text"
