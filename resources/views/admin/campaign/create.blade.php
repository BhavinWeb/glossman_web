            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('campaign_create') }}</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-10 offset-md-1">
                            <form enctype="multipart/form-data" action="{{ route('campaigns.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="products[]" multiple
                                                ...
                                                @foreach ($products as $product)
                                                    <option
                                                        {{ collect(old('products'))->contains($product->id) || $loop->index == 0 ? 'selected' : '' }}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group date datepicker">
                                                    <input type="text"
                                                        ...
                                                        name="start_date" value="{{ old('start_date') }}" id="date"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group date datepicker">
                                                    <input type="text"
                                                        ...
                                                        name="end_date" value="{{ old('end_date') }}" id="date"
                                                        placeholder="dd/mm/yyyy" class="" />
                                                    @error('end_date')
                                                        <span class="invalid-feedback"
                                                            role="alert"><strong>{{ $message }}</strong></span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input value="{{ old('discount_amount') }}" name="discount_amount"
                                                    type="number"
