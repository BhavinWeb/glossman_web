                    ...
                    <div class="card-body">
                        <form action="{{ route('settings.custom.update') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="headerCss">{{ __('header_custom_style') }}
                                    ({{ __('before_head_end') }})</label>
                            ...
                            <div class="form-group">
                                <label name=""
                                    for="headerScript">{{ __('header_custom_script') }}({{ __('before_head_end') }})</label>
                            ...
                            <div class="form-group">
                                <label for="bodyScript">{{ __('footer_custom_script') }}
                                    ({{ __('before_body_end') }})</label>
