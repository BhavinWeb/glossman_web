    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-header">{{ __('navbar_background_color') }}</div>
                        <div class="card-body">
                            <div class="frontend-navbar-bg-color"></div>
                        </div>
                    </div>
                </div>
                <div class="col-3">
                    <div class="card">
                        <div class="card-header">{{ __('navbar_text_color') }}</div>
                        <div class="card-body">
                            <div class="frontend-navbar-txt-color"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="px-4 pt-3 pb-4">
                    <form id="color_picker_form" action="{{ route('settings.theme.update') }}" method="post">
                        ...
                        <input id="frontend_navbar_bg_id" type="hidden" name="frontend_navbar_bg_color"
                            value="{{ $setting->frontend_navbar_bg_color }}">
                        <input id="frontend_navbar_txt_id" type="hidden" name="frontend_navbar_txt_color"
                            value="{{ $setting->frontend_navbar_txt_color }}">
                    </form>
                    <div class="row">
                        <div class="col-6">
                            <div class="card">
...
@section('script')
    ...
    <script>
        ...
        const colorPickers = [{
            ...
            {
                el: ".frontend-navbar-bg-color",
                default: '{{ $setting->frontend_navbar_bg_color }}',
                variable: '--frontend-navbar-bg-color',
                input: "#frontend_navbar_bg_id",
            },
            {
                el: ".frontend-navbar-txt-color",
                default: '{{ $setting->frontend_navbar_txt_color }}',
                variable: '--frontend-navbar-txt-color',
                input: "#frontend_navbar_txt_id",
            },
        ]
