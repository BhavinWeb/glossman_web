        ...
        <div class="col-md-4">
            ...
            @if (empty($manual_payment))
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.payment.manual.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <x-forms.label name="name" for="name" :required="true" />
                                <input id="name" type="text" name="name"
                                    placeholder="{{ __('enter') }} {{ __('name') }}" value="{{ old('name') }}"
                                    class="form-control @error('name') is-invalid @enderror">
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <p id="contact-modal-type"></p>
                        </div>
                        <div class="form-group">
                            <label>{{ __('description') }}</label>
                            <div id="contact-modal-description"></div>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        function contactDetail(contact) {
            $('#contact-modal-name').text(contact.name);
            $('#contact-modal-type').text(contact.type.replace("_", " ").toUpperCase());
            $('#contact-modal-description').html(contact.description);
