    ...
    <div class="wrapper">
        ...
        <nav id="nav"
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a title="{{ __('Browse Website') }}" target="_blank" class="nav-link"
                        href="{{ url('/') }}" class="btn btn-primary mt-4 mx-3 text-white">
                        <i class="fas fa-globe fa-2"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a title="{{ __('clear_cache') }}" class="nav-link"
                        href="{{ route('app.optimize-clear') }}" class="btn btn-primary mt-4 mx-3 text-white">
                ...
                <div class="container-fluid">
                    @if (!checkMailConfig())
                        <div class="alert alert-warning" role="alert">
                            {{ __('please_configure_your_mail_settings_in_the_settings_page') }}
                            <a href="{{ route('settings.email') }}"
                                class="text-dark">{{ __('go_to_settings') }}</a>
                        </div>
                    @endif
                    @yield('content')
                    <!-- /.row -->
