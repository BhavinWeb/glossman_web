            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('Driver Edit') }}
                        </h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('driver.update') }}" method="POST"
                              ...
                              <input value="{{$data->id}}" name="id" type="hidden">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{$data->phone}}" name="phone" type="text"
                                            class="form-control @error('phone') phone is-invalid @enderror"
                                            placeholder="xxx - xxxx" minlength="10" maxlength="10" required>
                                        @error('phone')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{$data->password}}" name="password" type="password"
